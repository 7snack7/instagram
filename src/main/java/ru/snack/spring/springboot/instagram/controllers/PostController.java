...
import ru.snack.spring.springboot.instagram.facade.PostFacade;
import ru.snack.spring.springboot.instagram.payload.response.MessageResponse;
import ru.snack.spring.springboot.instagram.services.PostService;
...
public class PostController {
    ...
    public ResponseEntity<Object> likePost(@PathVariable("postId") String postId, @PathVariable("username") String username) {
